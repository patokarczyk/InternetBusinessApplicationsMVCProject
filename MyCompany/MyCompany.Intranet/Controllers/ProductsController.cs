...
namespace MyCompany.Intranet.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(MyCompanyIntranetContext context)
        {
            _context = context;
        }
        ...
        {
            var myCompanyIntranetContext = _context.Product.Include(p => p.Category);
        ...
        public async Task<IActionResult> Create([Bind("IdProduct,Name,Description,Price,IdCategory")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduct,Name,Description,Price,IdCategory")] Product product)
        {
