...
namespace MyCompany.Intranet.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public SuppliersController(MyCompanyIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdSupplier,Name,Phone,Email")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSupplier,Name,Phone,Email")] Supplier supplier)
        {
